...
function getNewValue( key )
{
   ...
   if ( checkValue == "cmi.interactions" )
   {
      ...
      checkValue2 =  keyResult.substring(19+idCharCount,23+idCharCount);
      
      if ( checkValue2 == "time" )
      {
         // Return cmi.interactions.n.timestamp
         var subString1 = keyResult.substring(0,19+idCharCount);
...
// variables over multiple learner sessions (within learner attempt) this 
// code could be used.
/**************************************************************************
**
** Function: setcookie()
