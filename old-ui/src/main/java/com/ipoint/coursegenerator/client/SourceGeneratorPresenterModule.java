...
public class SourceGeneratorPresenterModule extends AbstractPresenterModule {
	...
	bindPresenter(CourseGeneratorMainPresenter.class,
		CourseGeneratorMainPresenter.MyView.class,
		CourseGeneratorMainView.class,
		CourseGeneratorMainPresenter.MyProxy.class);

	bindPresenter(CourseGeneratorFormPresenter.class,
		CourseGeneratorFormPresenter.MyView.class,
		CourseGeneratorFormView.class,
		CourseGeneratorFormPresenter.MyProxy.class);
    }
}