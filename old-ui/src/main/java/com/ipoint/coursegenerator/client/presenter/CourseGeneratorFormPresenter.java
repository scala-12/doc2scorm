...
public class CourseGeneratorFormPresenter
	extends
	Presenter<CourseGeneratorFormPresenter.MyView, CourseGeneratorFormPresenter.MyProxy>
	implements FileSelectUIHandler {
